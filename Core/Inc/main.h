...
#define DISCR_INPUT_OFFSET	APDS_SIZE+TLA2024_SIZE+DHT22_SIZE+CV_SIZE+GERCON_SIZE+ENGINE_STATE_SIZE+PACK_HEADER_SIZE
#define CV_STATUS_OFFSET	APDS_SIZE+TLA2024_SIZE+DHT22_SIZE+CV_SIZE+GERCON_SIZE+ENGINE_STATE_SIZE+DISCRETE_IN_SIZE+PACK_HEADER_SIZE
#define MIS_STATUS_OFFSET	APDS_SIZE+TLA2024_SIZE+DHT22_SIZE+CV_SIZE+GERCON_SIZE+ENGINE_STATE_SIZE+DISCRETE_IN_SIZE+CV_STATUS_SIZE+PACK_HEADER_SIZE
#define CV_FIRMWARE_OFFSET	APDS_SIZE+TLA2024_SIZE+DHT22_SIZE+CV_SIZE+GERCON_SIZE+ENGINE_STATE_SIZE+DISCRETE_IN_SIZE+CV_STATUS_SIZE+MIS_STATUS_SIZE+PACK_HEADER_SIZE
#define MIS_FIRMWARE_OFFSET	APDS_SIZE+TLA2024_SIZE+DHT22_SIZE+CV_SIZE+GERCON_SIZE+ENGINE_STATE_SIZE+DISCRETE_IN_SIZE+CV_STATUS_SIZE+MIS_STATUS_SIZE+CV_FIRMWARE_SIZE+PACK_HEADER_SIZE
#define STD_PACK_SIZE		APDS_SIZE+TLA2024_SIZE+DHT22_SIZE+CV_SIZE+GERCON_SIZE+ENGINE_STATE_SIZE+DISCRETE_IN_SIZE+CV_STATUS_SIZE+MIS_STATUS_SIZE+CV_FIRMWARE_SIZE+MIS_FIRMWARE_SIZE+RESERVE_SIZE+PACK_HEADER_SIZE+PACK_FOOTER_SIZE //61
