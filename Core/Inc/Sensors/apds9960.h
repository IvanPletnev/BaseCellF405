...
extern uint8_t getAmbientLightGain();
extern uint8_t sensorReadDataByte(uint16_t Register_Addr, uint8_t *Register_Data);
extern uint8_t enablePower();
extern uint8_t disablePower();
